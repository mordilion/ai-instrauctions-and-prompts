...
**Note**: User explicitly reverted aggressive optimizations to these 2 files, indicating preference for detailed infrastructure templates and test patterns. These files intentionally kept verbose.
