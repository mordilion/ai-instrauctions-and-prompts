...
PROJECT_MEMORY.md - Node version, frameworks, lessons
...
START: Execute Phase 1 - detect Node version, choose frameworks
CONTINUE: Execute phases 2-4 iteratively
REMEMBER: Use Jest mocks, don't fix bugs, iterate
```
